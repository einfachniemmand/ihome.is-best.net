...
function onloadanimation () {
                ...
                document.getElementById('rot_ani').style.left = (anfang-150)+'px';
                document.getElementById('beige_ani').style.left = (anfang-300)+'px';
                document.getElementById('green_ani').style.left = (anfang-450)+'px';
                document.getElementById('blue_ani').style.left = (anfang-600)+'px';
                document.getElementById('pink_ani').style.left = (anfang-750)+'px';
